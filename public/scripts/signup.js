        ...
        .then(data => {
            if (data.error){
                ...
                if (data.message == "User with this username already exists"){
                    ...
                    document.querySelector('.user-taken-message').innerText = data.message;
                    ...
                    document.querySelector('.email-taken-message').innerText = data.message;
                    ...
                    document.querySelector('.email-taken').style.display = 'flex';
                    document.querySelector('.email-taken-message').innerText = data.message[0];
                    document.querySelector('.user-taken').style.display = 'none'
                    weak.style.display = 'none';
